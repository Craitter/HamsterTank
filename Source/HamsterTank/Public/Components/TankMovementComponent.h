...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Tank|Movement|Physics", meta=(ClampMin="0.1", UIMin="0.1", ForceUnits="m/ss"))
	float ForwardConstantAcceleration = 6.0f;
	// this is the Constant Acceleration applied to the Force when moving Backward m/(s*s)
	UPROPERTY(EditDefaultsOnly, Category = "Tank|Movement|Physics", meta=(ClampMin="0.1", UIMin="0.1", ForceUnits="m/ss"))
	float BackwardConstantAcceleration = 6.0f;
	...
	UPROPERTY(EditDefaultsOnly, Category = "Tank|Movement|Physics", meta=(ClampMin="0.1", UIMin="0.1", ForceUnits="cm"))
	float BreakingDistance = 400.0f;
	...
	UPROPERTY(EditDefaultsOnly, Category = "Tank|Movement|Physics", meta=(ClampMin="0.1", UIMin="0.1", ForceUnits="m/ss"))
	float MinBreakingDeceleration = 10.0f;

	//The highest possible speed when driving forward Default Value = 60Km/h / 3.6 = 16.66667
	UPROPERTY(EditDefaultsOnly, Category = "Tank|Movement|Speed", meta = (ClampMin="0.1", UIMin="0.1", ForceUnits="m/s"))
	float ForwardMaxSpeed = 14.0f;
